package edu.calvin.cs262.project01.Messaging;
...
import edu.calvin.cs262.project01.Login;
import edu.calvin.cs262.project01.Profile;
import edu.calvin.cs262.project01.R;
import edu.calvin.cs262.project01.Settings;
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        scaledrone.connect(new Listener() {
            ...
            public void onOpen() {
                ...
                scaledrone.subscribe(roomName, edu.calvin.cs262.project01.Messaging.Messaging.this);
            }
